"""
bitget_relay.py — AURA v1.2.8 local CORS proxy, web server & state sync
======================================================================
...
API-Vertrag (für das Dashboard):
  ...
  GET  /serving          -> {"ok": true, "version": "1.2.8", "port": 8787, "mode": "quant_research"}
...
VERSION = _VERSION_FILE.read_text(encoding="utf-8").strip() if _VERSION_FILE.exists() else "1.2.8"
