"""
bitget_relay.py — AURA v1.1.2 local CORS proxy, web server & state sync
======================================================================
...
API-Vertrag (für das Dashboard):
  ...
  GET  /serving          -> {"ok": true, "version": "1.1.2", "port": 8787, "mode": "quant_research"}
...
if __name__ == "__main__":
    ...
    log.info("AURA Relay v1.1.2 listening on http://%s:%d", HOST, PORT)
