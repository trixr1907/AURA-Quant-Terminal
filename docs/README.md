...
Willkommen im zentralen Dokumentations-Hub von **AURA v1.7.0 — Confluence Terminal**.
...
├── releases/                  # Release-Notes aller Versionen (v1.1.0–v1.7.0)  [Pflege: Release-Manager]
│   ├── RELEASE_v1.7.0.md      # Aktuelles Release (v1.7.0, MINOR: Headless Paper-Autobot)
