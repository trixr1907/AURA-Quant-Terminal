...
- **UI-Gen2-Vorbereitung (R35b):** Funktionsgleicher CSS-Slice mit Tokens, 420-px-Regeln, 44-px-Touchzielen, Focus-Ringen und Reduced-Motion-Unterstützung; vollständige WCAG-/Viewport-/Komponentenabnahme folgt in v2.1.0.
...
### Scope
- MAJOR (`2.0.0`) aufgrund der inkompatiblen, versionierten Laufzeit-Datenform; nicht aufgrund einer Strategieänderung.
