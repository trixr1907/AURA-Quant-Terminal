...
assert.deepStrictEqual(App.data.chart, { stale: true }, 'chart data must stay visible as stale-while-revalidate during reload');
assert.deepStrictEqual(App.data.candles, [{ t: 9 }], 'candles must stay visible as stale-while-revalidate during reload');
