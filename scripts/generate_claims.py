...
CLAIMS = [
    ...
    },
    {
        ...
        "Wortlaut": "Version 2.0.0 einheitlich in allen Systemkomponenten",
        "Typ": "Zahl",
        "Ebene_Querschnitt": "Ebene 3",
        "Status": "WAHR",
        "Schweregrad": "INFO",
        "Beleg_Repro": "scripts/release_check.py Gate 'version consistency' PASS; alle aktuellen Versionsflächen matchen exakt '2.0.0'.",
