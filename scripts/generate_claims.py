...
CLAIMS = [
    ...
    },
    {
        ...
        "Wortlaut": "Version 1.2.1 einheitlich in allen Systemkomponenten",
        "Typ": "Zahl",
        "Ebene_Querschnitt": "Ebene 3",
        "Status": "WAHR",
        "Schweregrad": "INFO",
        "Beleg_Repro": "scripts/release_check.py Gate 'version consistency' PASS; alle 9 Vorkommen matchen exakt '1.2.1'.",
