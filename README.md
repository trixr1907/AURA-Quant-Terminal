...
# AURA v2.1.0 — Confluence Terminal

<div align="center">
  <a href="VERSION"><img src="https://img.shields.io/badge/version-2.1.0-00F5A0?style=for-the-badge&labelColor=080B11" alt="Version 2.1.0"></a>
...
- [**Aktuelles Release v2.1.0 (docs/releases/RELEASE_v2.1.0.md)**](docs/releases/RELEASE_v2.1.0.md) — MINOR: UI-Generation 2 finalisiertes Design-System, standardisierte CSS-Tokens, responsive Mobil-Regeln (390/420 px) und WCAG-AA-Kontrast.
