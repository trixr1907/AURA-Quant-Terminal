# AURA v1.0.4 — Smart Quant Terminal
...
AURA v1.0.4 dient ausschließlich Quant Research, Setup Discovery und reproduzierbarer Modellvalidierung. Keine Anlageberatung.
