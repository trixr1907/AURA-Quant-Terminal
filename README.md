...
# AURA v2.3.0 — Confluence Terminal

<div align="center">
  <a href="VERSION"><img src="https://img.shields.io/badge/version-2.3.0-00F5A0?style=for-the-badge&labelColor=080B11" alt="Version 2.3.0"></a>
...
- [**Aktuelles Release v2.3.0 (docs/releases/RELEASE_v2.3.0.md)**](docs/releases/RELEASE_v2.3.0.md) — MINOR: Evidence Infra Completion — S6-Elevation-Gate, 90-Tage-Rollfenster, Evidence-Decay, Kostenmodell-Vereinheitlichung (0.1%/0.1%/0.1%) aller 5 Pfade, Lockbox-Erzwingung.
