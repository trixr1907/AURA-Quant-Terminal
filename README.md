# AURA v1.0.2 — Smart Quant Terminal
...
AURA v1.0.2 dient ausschließlich Quant Research, Setup Discovery und reproduzierbarer Modellvalidierung. Keine Anlageberatung.
