# AURA v1.0.1 — Smart Quant Terminal
...
AURA v1.0.1 dient ausschließlich Quant Research, Setup Discovery und reproduzierbarer Modellvalidierung. Keine Anlageberatung.
