# AURA v1.0.9 — Smart Quant Terminal
...
AURA v1.0.9 dient ausschließlich Quant Research, Setup Discovery und reproduzierbarer Modellvalidierung. Keine Anlageberatung.
